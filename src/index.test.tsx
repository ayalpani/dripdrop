...
import { dripdrop, getSubscriptionCallbacksForTesting } from "./index";
...
test("testing single subscribed component", async () => {
  ...
  // trigger rerender
  act(() => dripdrop.notifySubscribers("toggle"));
